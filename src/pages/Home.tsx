  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-white text-center px-4">
      <div className="flex items-center justify-center py-4 px-10">
        <h2 className="mb-2 sm:text-xl md:text-2xl text-[0.85rem] font-semibold text-[#a5a0bc]">
          {t('definitionHeading')}
        </h2>
      </div>

      <h1 className="text-3xl sm:text-3xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight bg-gradient-to-r from-[#BF2ECE] to-[#881CE5] text-transparent bg-clip-text py-2">
        {t('mainTitle')}
      </h1>

      <p className="text-[0.75rem] sm:text-xl md:text-2xl lg:text-lg mb-6 max-w-4xl text-white">
        {t('description')}
      </p>

      <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 mt-2 mb-6">
      ...
      <div className="relative w-full max-w-5xl py-12 px-4 rounded-lg text-white overflow-hidden mt-6 mb-12 z-[-50]">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-10"
          style={{ backgroundImage: "url('/Container.svg')" }}
          aria-hidden="true"
        />
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-12 text-left">
